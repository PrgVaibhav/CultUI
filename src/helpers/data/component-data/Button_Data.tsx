...
export const BUTTON_DATA: ComponentCardData = {
  id: 1,
  title: "Button",
  description:
  ...
  variations: [
    {
      ...
      code: `<Button size="md" cn="bg-blue-600 text-slate-300">Primary Button</Button>`,
    },
    {
      id: 2,
      ...
      code: `<Button size="md" cn="bg-transparent text-slate-300 hover:bg-gray-600">Invisible Button</Button>`,
    },
    {
      id: 3,
      ...
      code: `<Button size="md" cn="bg-blue-600 text-slate-300" disable>Disabled Button</Button>`,
    },
    {
      id: 4,
      title: "Icon Buttons.",
      ...
      code: `<Button size="md" cn="bg-zinc-800 text-slate-300" leftIcon={"🔥"}>Left Icon Button</Button> \n<Button size="md" cn="bg-zinc-800 text-slate-300" rightIcon={"🔥"}>Right Icon Button</Button>`,
    },
    {
      id: 4,
      title: "Loading Button.",
      description:
        "Button with a loading state. You can use this button for any loading state.",
      component: (
        <>
          <Button size="md" cn="bg-blue-800 text-slate-300" isLoading>
            Wait Loading...
          </Button>
        </>
      ),
      code: `<Button size="md" cn="bg-blue-800 text-slate-300" isLoading>Wait Loading...</Button>`,
    },
  ],
};
